...
describe("buildRgArgs parameter builder", () => {
  ...
  it("caps max-columns to MAX_MATCH_LINE_BYTES server hard limit", () => {
    ...
    const smallerArgs = buildRgArgs({ pattern: "test", "max-columns": 100 });
    ...
    const largerArgs = buildRgArgs({ pattern: "test", "max-columns": 999999 });
